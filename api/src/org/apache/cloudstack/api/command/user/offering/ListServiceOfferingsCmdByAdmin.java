...
public class ListServiceOfferingsCmdByAdmin extends ListServiceOfferingsCmd {
    public static final Logger s_logger = Logger.getLogger(ListServiceOfferingsCmdByAdmin.class.getName());
    ...
    @Override
    public void execute() {
        ListResponse<ServiceOfferingResponse> response = _queryService.searchForServiceOfferings(ResponseView.Full, this);
